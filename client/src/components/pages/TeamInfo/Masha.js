        ...
        <div className='container py-5'>
          <div className='row'>
            <div className='col-10 mx-auto col-md-6 my-3'>
              <img src={masha} alt='Masha' className='img-fluid' />
            </div>
            <div
            ...
            >
              <h3>
                Name: <span style={{ color: '#9b8884' }}>Maria Chuikina</span>
              </h3>
              ...
              <h3 className='text-information'>
                ...
                <a href='https://www.github.com/ChuikinaMaria'>
                  <i className='mx-1 fab fa-github'></i>
                </a>
                <a href='https://www.linkedin.com/in/maria-chuikina-49168787'>
