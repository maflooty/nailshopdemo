...
export default class Dena extends Component {
  render() {
    return (
      <div>
        <div className='container py-5'>
          <div className='row'>
            <div className='col-10 mx-auto col-md-6 my-3'>
              <img src={dena} alt='Dena' className='img-fluid' />
            </div>
            <div
            ...
            >
              <h3>
                Name: <span style={{ color: '#9b8884' }}>Dena Cho</span>
              </h3>
              ...
              <h3 className='text-information'>
                ...
                <a href='https://www.github.com/denacho'>
                  <i className='mx-1 fab fa-github'></i>
                </a>
                <a href='https://www.linkedin.com/in/denacho1301'>
